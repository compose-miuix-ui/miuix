...
internal actual fun navKeyClassName(key: NavKey): String = key::class.qualifiedName
    ?: throw SerializationException("Cannot determine class name for anonymous NavKey: $key")

@InternalSerializationApi
@Suppress("UNCHECKED_CAST")
internal actual fun navKeySerializerByName(className: String): KSerializer<NavKey> = throw UnsupportedOperationException(
